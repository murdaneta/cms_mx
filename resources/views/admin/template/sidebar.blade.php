<aside class="sidebar">
    <div class="sidebar-container">
        <div class="sidebar-header">
            <div class="brand"> Sistema-90total</div>
        </div>
        <nav class="menu">
            <ul class="nav metismenu" id="sidebar-menu">
                <li class="active">
                    <a href="{{ route('system') }}"> <i class="fa fa-home"></i> Dashboard </a>
                </li>
                <li>
                    <a href="">
                        <i class="fa fa-th-large"></i> Noticias
                        <i class="fa arrow"></i>
                    </a>
                    <ul>
                        <li>
                            <a href="{{ route('system.news.create') }}">
                                Crear
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('system.news.index') }}"> 
                                Ver todas
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('system.categories.create') }}">
                                Crear
                            </a>
                        </li>
                        <li>
